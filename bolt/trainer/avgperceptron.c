/* Generated by Cython 0.14.1 on Thu Mar 24 08:39:56 2011 */
...
static PyObject *__pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron_1train(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "bolt/trainer/avgperceptron.pyx":98
 *         shuffled after each epoch.
 *         """
 ...
 */
  ...
  ((struct __pyx_vtabstruct_4bolt_7trainer_13avgperceptron_AveragedPerceptron *)((struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *)__pyx_v_self)->__pyx_vtab)->_train_multi(((struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *)__pyx_v_self), __pyx_t_1, __pyx_t_2, __pyx_t_3, __pyx_t_4);
...
/* "bolt/trainer/avgperceptron.pyx":100
 *         self._train_multi(model, dataset, verbose, shuffle)
 * 
 *     cdef void _train_multi(self,model, dataset, verbose, shuffle):             # <<<<<<<<<<<<<<
 *         cdef int m = model.m
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":106
 *         cdef int length = k*m
 * 
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] w = model.W             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":108
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] w = model.W
 *         # maintain a averaged w
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] wbar = np.zeros((k,m),             # <<<<<<<<<<<<<<
 *                                                                         dtype=np.float64)
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":117
 * 
 *         # training instance
 ...
 */
      ...
      /* "bolt/trainer/avgperceptron.pyx":144
 *                     nadds += 1
 * 
 *                 i += 1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "bolt/trainer/avgperceptron.pyx":146
 *                 i += 1
 *             # report epoche information
 *             if verbose > 0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":151
 * 
 *         # floating-point under-/overflow check.
 ...
 */
  ...
  /* "bolt/trainer/avgperceptron.pyx":154
 *             raise ValueError("floating-point under-/overflow occured.")
 * 
 *         model.W = wbar * (1.0 / (n*E))             # <<<<<<<<<<<<<<
 */
