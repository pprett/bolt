/* Generated by Cython 0.11.2 on Fri Sep 24 17:18:13 2010 */
...
/* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":25
 * # ----------------------------------------
 * 
 * cdef struct Pair:             # <<<<<<<<<<<<<<
 *     np.uint32_t idx
...
/* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":64
 *     return max_j
 * 
...
static char __pyx_k_35[] = "NADDs: %d; NNZs: %d. ";
...
/* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":29
 *     np.float32_t val
 * 
...
static  double __pyx_f_4bolt_7trainer_13avgperceptron_dot(double *__pyx_v_w, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *__pyx_v_x, int __pyx_v_nnz) {
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":32
 *     """Dot product of weight vector w and example x.
 *     """
 *     cdef double sum = 0.0             # <<<<<<<<<<<<<<
 *     cdef Pair pair
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":35
 *     cdef Pair pair
 *     cdef int i
 *     for i from 0 <= i < nnz:             # <<<<<<<<<<<<<<
 *         pair = x[i]
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":36
 *     cdef int i
 *     for i from 0 <= i < nnz:
 *         pair = x[i]             # <<<<<<<<<<<<<<
 *         sum += w[pair.idx] * pair.val
 ...
 */
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":37
 *     for i from 0 <= i < nnz:
 *         pair = x[i]
 *         sum += w[pair.idx] * pair.val             # <<<<<<<<<<<<<<
 *     return sum
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":38
 *         pair = x[i]
 *         sum += w[pair.idx] * pair.val
 *     return sum             # <<<<<<<<<<<<<<
 * 
...
/* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":40
 *     return sum
 * 
 * cdef void add(double *w, int stride, Pair *x, int nnz, int y, double c, double *wbar, double u):             # <<<<<<<<<<<<<<
 *     cdef Pair pair
...
static  void __pyx_f_4bolt_7trainer_13avgperceptron_add(double *__pyx_v_w, int __pyx_v_stride, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *__pyx_v_x, int __pyx_v_nnz, int __pyx_v_y, double __pyx_v_c, double *__pyx_v_wbar, double __pyx_v_u) {
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":43
 *     cdef Pair pair
 *     cdef int i
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":44
 *     cdef int i
 *     cdef int offset = (y*stride)
 *     for i from 0 <= i < nnz:             # <<<<<<<<<<<<<<
 *         pair = x[i]
 ...
 */
  ...
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_t_1; __pyx_v_i++) {
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":45
 *     cdef int offset = (y*stride)
 *     for i from 0 <= i < nnz:
 *         pair = x[i]             # <<<<<<<<<<<<<<
 *         w[offset + pair.idx] += (pair.val * c)
 ...
 */
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":46
 *     for i from 0 <= i < nnz:
 *         pair = x[i]
 *         w[offset + pair.idx] += (pair.val * c)             # <<<<<<<<<<<<<<
 *         wbar[offset + pair.idx] += (c*u*pair.val)
 ...
 */
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":47
 *         pair = x[i]
 *         w[offset + pair.idx] += (pair.val * c)
 *         wbar[offset + pair.idx] += (c*u*pair.val)             # <<<<<<<<<<<<<<
 * 
...
/* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":49
 *         wbar[offset + pair.idx] += (c*u*pair.val)
 * 
 * cdef int argmax(double *w, int wstride, Pair *x, int xnnz, int y, int k):             # <<<<<<<<<<<<<<
 *     cdef Pair pair
...
static  int __pyx_f_4bolt_7trainer_13avgperceptron_argmax(double *__pyx_v_w, int __pyx_v_wstride, struct __pyx_t_4bolt_7trainer_13avgperceptron_Pair *__pyx_v_x, int __pyx_v_xnnz, int __pyx_v_y, int __pyx_v_k) {
  ...
  int __pyx_t_1;
  int __pyx_t_2;
  __Pyx_SetupRefcountContext("argmax");

  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":53
 *     cdef int j
 *     cdef double *wk
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":54
 *     cdef double *wk
 *     cdef double max_score = -1.0
 *     cdef double p = 0.0             # <<<<<<<<<<<<<<
 *     cdef int max_j = 0
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":55
 *     cdef double max_score = -1.0
 *     cdef double p = 0.0
 *     cdef int max_j = 0             # <<<<<<<<<<<<<<
 *     for j from 0 <= j < k:
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":56
 *     cdef double p = 0.0
 *     cdef int max_j = 0
 *     for j from 0 <= j < k:             # <<<<<<<<<<<<<<
 *         wk = w + (wstride*j)
 ...
 */
  ...
  for (__pyx_v_j = 0; __pyx_v_j < __pyx_t_1; __pyx_v_j++) {
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":57
 *     cdef int max_j = 0
 *     for j from 0 <= j < k:
 *         wk = w + (wstride*j)             # <<<<<<<<<<<<<<
 *         p = dot(wk, x, xnnz)
 ...
 */
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":58
 *     for j from 0 <= j < k:
 *         wk = w + (wstride*j)
 *         p = dot(wk, x, xnnz)             # <<<<<<<<<<<<<<
 *         if p >= max_score:
 ...
 */
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":59
 *         wk = w + (wstride*j)
 *         p = dot(wk, x, xnnz)
 *         if p >= max_score:             # <<<<<<<<<<<<<<
 *             max_j = j
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":60
 *         p = dot(wk, x, xnnz)
 *         if p >= max_score:
 *             max_j = j             # <<<<<<<<<<<<<<
 *             max_score = p
 ...
 */
      ...
      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":61
 *         if p >= max_score:
 *             max_j = j
 *             max_score = p             # <<<<<<<<<<<<<<
 *     return max_j
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":62
 *             max_j = j
 *             max_score = p
 *     return max_j             # <<<<<<<<<<<<<<
 * 
...
/* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":76
 *     cdef int epochs
 * 
...
static int __pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":81
 *         :type epochs: int
 *         """
 *         self.epochs = epochs             # <<<<<<<<<<<<<<
 * 
...
/* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":84
 * 
 * 
...
static PyObject *__pyx_pf_4bolt_7trainer_13avgperceptron_18AveragedPerceptron_train(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":92
 *         :arg shuffle: Whether or not the training data should be shuffled after each epoch.
 *         """
...
/* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":94
 *         self._train_multi(model, dataset, verbose, shuffle)
 * 
 *     cdef void _train_multi(self,model, dataset, verbose, shuffle):             # <<<<<<<<<<<<<<
 *         cdef int m = model.m
...
static  void __pyx_f_4bolt_7trainer_13avgperceptron_18AveragedPerceptron__train_multi(struct __pyx_obj_4bolt_7trainer_13avgperceptron_AveragedPerceptron *__pyx_v_self, PyObject *__pyx_v_model, PyObject *__pyx_v_dataset, PyObject *__pyx_v_verbose, PyObject *__pyx_v_shuffle) {
  ...
  int __pyx_t_13;
  int __pyx_t_14;
  __Pyx_SetupRefcountContext("_train_multi");
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":95
 * 
 *     cdef void _train_multi(self,model, dataset, verbose, shuffle):
 *         cdef int m = model.m             # <<<<<<<<<<<<<<
 *         cdef int k = model.k
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_model, __pyx_kp_m); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 95; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":96
 *     cdef void _train_multi(self,model, dataset, verbose, shuffle):
 *         cdef int m = model.m
 *         cdef int k = model.k             # <<<<<<<<<<<<<<
 *         cdef int n = dataset.n
 *         cdef int length = k*m
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_model, __pyx_kp_k); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":97
 *         cdef int m = model.m
 *         cdef int k = model.k
 *         cdef int n = dataset.n             # <<<<<<<<<<<<<<
 *         cdef int length = k*m
 * 
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_dataset, __pyx_kp_n); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":98
 *         cdef int k = model.k
 *         cdef int n = dataset.n
 *         cdef int length = k*m             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":100
 *         cdef int length = k*m
 * 
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] w = model.W             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = PyObject_GetAttr(__pyx_v_model, __pyx_kp_W); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (!(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":102
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] w = model.W
 *         # maintain a averaged w
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] wbar = np.zeros((k,m),             # <<<<<<<<<<<<<<
 *                                                                         dtype = np.float64)
 ...
 */
  ...
  __pyx_t_1 = PyObject_GetAttr(__pyx_1, __pyx_kp_zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_t_4 = PyInt_FromLong(__pyx_v_k); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":103
 *         # maintain a averaged w
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] wbar = np.zeros((k,m),
 *                                                                         dtype = np.float64)             # <<<<<<<<<<<<<<
 *         cdef double *wdata = <double *>w.data
 ...
 */
  __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_kp_np); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_2);
  __pyx_t_6 = PyObject_GetAttr(__pyx_2, __pyx_kp_33); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 103; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_2); __pyx_2 = 0;
  if (PyDict_SetItem(__pyx_1, __pyx_kp_dtype, __pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = PyEval_CallObjectWithKeywords(__pyx_t_1, ((PyObject *)__pyx_t_5), ((PyObject *)__pyx_1)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_5)); __pyx_t_5 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_1)); __pyx_1 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_6, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 102; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_6);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_wbar, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_7 = 0;
  __pyx_v_wbar = ((PyArrayObject *)__pyx_t_6);
  __pyx_t_6 = 0;

  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":104
 *         cdef np.ndarray[np.float64_t, ndim=2, mode="c"] wbar = np.zeros((k,m),
 *                                                                         dtype = np.float64)
 *         cdef double *wdata = <double *>w.data             # <<<<<<<<<<<<<<
 *         cdef double *wbardata = <double *>wbar.data
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":105
 *                                                                         dtype = np.float64)
 *         cdef double *wdata = <double *>w.data
 *         cdef double *wbardata = <double *>wbar.data             # <<<<<<<<<<<<<<
 *         cdef int wstride0 = w.strides[0]
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":106
 *         cdef double *wdata = <double *>w.data
 *         cdef double *wbardata = <double *>wbar.data
 *         cdef int wstride0 = w.strides[0]             # <<<<<<<<<<<<<<
 *         cdef int wstride1 = w.strides[1]
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":107
 *         cdef double *wbardata = <double *>wbar.data
 *         cdef int wstride0 = w.strides[0]
 *         cdef int wstride1 = w.strides[1]             # <<<<<<<<<<<<<<
 *         cdef int wstride = <int> (wstride0 / wstride1)
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":108
 *         cdef int wstride0 = w.strides[0]
 *         cdef int wstride1 = w.strides[1]
 *         cdef int wstride = <int> (wstride0 / wstride1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":111
 * 
 *         # training instance
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":112
 *         # training instance
 *         cdef np.ndarray x = None
 *         cdef Pair *xdata = NULL             # <<<<<<<<<<<<<<
 *         cdef float y = 0
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":113
 *         cdef np.ndarray x = None
 *         cdef Pair *xdata = NULL
 *         cdef float y = 0             # <<<<<<<<<<<<<<
 *         cdef int z = 0
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":114
 *         cdef Pair *xdata = NULL
 *         cdef float y = 0
 *         cdef int z = 0             # <<<<<<<<<<<<<<
 *         cdef int xnnz = 0, nadds = 0, i = 0
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":115
 *         cdef float y = 0
 *         cdef int z = 0
 *         cdef int xnnz = 0, nadds = 0, i = 0             # <<<<<<<<<<<<<<
 *         cdef int E = self.epochs
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":116
 *         cdef int z = 0
 *         cdef int xnnz = 0, nadds = 0, i = 0
 *         cdef int E = self.epochs             # <<<<<<<<<<<<<<
 *         cdef double u = 0.0
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":117
 *         cdef int xnnz = 0, nadds = 0, i = 0
 *         cdef int E = self.epochs
 *         cdef double u = 0.0             # <<<<<<<<<<<<<<
 *         t1=time()
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":118
 *         cdef int E = self.epochs
 *         cdef double u = 0.0
 *         t1=time()             # <<<<<<<<<<<<<<
 *         for e from 0 <= e < E:
 *             if verbose > 0:
 */
  __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_kp_time); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_2);
  __pyx_t_6 = PyObject_Call(__pyx_2, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_2); __pyx_2 = 0;
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":119
 *         cdef double u = 0.0
 *         t1=time()
 *         for e from 0 <= e < E:             # <<<<<<<<<<<<<<
 *             if verbose > 0:
 ...
 */
  ...
  for (__pyx_3 = 0; __pyx_3 < __pyx_t_2; __pyx_3++) {
    __pyx_t_6 = PyInt_FromLong(__pyx_3); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_v_e);
    __pyx_v_e = __pyx_t_6;
    __pyx_t_6 = 0;

    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":120
 *         t1=time()
 *         for e from 0 <= e < E:
 *             if verbose > 0:             # <<<<<<<<<<<<<<
 *                 print("-- Epoch %d" % (e+1))
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_8 = __Pyx_PyObject_IsTrue(__pyx_t_6); if (unlikely(__pyx_t_8 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 120; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    if (__pyx_t_8) {

      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":121
 *         for e from 0 <= e < E:
 *             if verbose > 0:
 *                 print("-- Epoch %d" % (e+1))             # <<<<<<<<<<<<<<
 *             if shuffle:
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_5 = PyNumber_Remainder(__pyx_kp_34, __pyx_t_6); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      if (__Pyx_PrintOne(__pyx_t_5) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      goto __pyx_L5;
    }
    __pyx_L5:;

    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":122
 *             if verbose > 0:
 *                 print("-- Epoch %d" % (e+1))
 *             if shuffle:             # <<<<<<<<<<<<<<
 *                 dataset.shuffle()
 *             nadds = 0
 */
    __pyx_t_8 = __Pyx_PyObject_IsTrue(__pyx_v_shuffle); if (unlikely(__pyx_t_8 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (__pyx_t_8) {

      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":123
 *                 print("-- Epoch %d" % (e+1))
 *             if shuffle:
 *                 dataset.shuffle()             # <<<<<<<<<<<<<<
 *             nadds = 0
 *             i = 0
 */
      __pyx_t_5 = PyObject_GetAttr(__pyx_v_dataset, __pyx_kp_shuffle); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 123; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = PyObject_Call(__pyx_t_5, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 123; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      goto __pyx_L6;
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":124
 *             if shuffle:
 *                 dataset.shuffle()
 *             nadds = 0             # <<<<<<<<<<<<<<
 *             i = 0
 ...
 */
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":125
 *                 dataset.shuffle()
 *             nadds = 0
 *             i = 0             # <<<<<<<<<<<<<<
 *             for x,y in dataset:
 ...
 */
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":126
 *             nadds = 0
 *             i = 0
 *             for x,y in dataset:             # <<<<<<<<<<<<<<
 *                 xnnz = x.shape[0]
 ...
 */
    if (PyList_CheckExact(__pyx_v_dataset) || PyTuple_CheckExact(__pyx_v_dataset)) {
      __pyx_t_9 = 0; __pyx_t_6 = __pyx_v_dataset; __Pyx_INCREF(__pyx_t_6);
    } else {
      __pyx_t_9 = -1; __pyx_t_6 = PyObject_GetIter(__pyx_v_dataset); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
    }
    for (;;) {
      ...
      if (PyTuple_CheckExact(__pyx_t_5) && likely(PyTuple_GET_SIZE(__pyx_t_5) == 2)) {
        ...
        if (!(__Pyx_TypeTest(__pyx_2, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __pyx_4 = PyTuple_GET_ITEM(tuple, 1); __Pyx_INCREF(__pyx_4);
        __pyx_t_10 = __pyx_PyFloat_AsDouble(__pyx_4); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        ...
        __pyx_1 = PyObject_GetIter(__pyx_t_5); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_1);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        ...
        __Pyx_GOTREF(__pyx_2);
        if (!(__Pyx_TypeTest(__pyx_2, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __pyx_4 = __Pyx_UnpackItem(__pyx_1, 1); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":127
 *             i = 0
 *             for x,y in dataset:
 *                 xnnz = x.shape[0]             # <<<<<<<<<<<<<<
 *                 xdata = <Pair *>x.data
 ...
 */
      ...
      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":128
 *             for x,y in dataset:
 *                 xnnz = x.shape[0]
 *                 xdata = <Pair *>x.data             # <<<<<<<<<<<<<<
 *                 z = argmax(wdata, wstride, xdata, xnnz, <int>y, k)
 ...
 */
      ...
      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":129
 *                 xnnz = x.shape[0]
 *                 xdata = <Pair *>x.data
 *                 z = argmax(wdata, wstride, xdata, xnnz, <int>y, k)             # <<<<<<<<<<<<<<
 *                 u = <double>(E*n - (n*e+i+1))
 ...
 */
      ...
      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":130
 *                 xdata = <Pair *>x.data
 *                 z = argmax(wdata, wstride, xdata, xnnz, <int>y, k)
 *                 u = <double>(E*n - (n*e+i+1))             # <<<<<<<<<<<<<<
 *                 if z != y:
 ...
 */
      __pyx_t_5 = PyInt_FromLong((__pyx_v_E * __pyx_v_n)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_1 = PyInt_FromLong(__pyx_v_n); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_4 = PyNumber_Multiply(__pyx_t_1, __pyx_v_e); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyInt_FromLong(__pyx_v_i); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_11 = PyNumber_Add(__pyx_t_4, __pyx_t_1); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_11);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyNumber_Add(__pyx_t_11, __pyx_int_1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_t_11 = PyNumber_Subtract(__pyx_t_5, __pyx_t_1); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_11);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_12 = __pyx_PyFloat_AsDouble(__pyx_t_11); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_v_u = ((double)__pyx_t_12);

      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":131
 *                 z = argmax(wdata, wstride, xdata, xnnz, <int>y, k)
 *                 u = <double>(E*n - (n*e+i+1))
 *                 if z != y:             # <<<<<<<<<<<<<<
 *                     add(wdata, wstride, xdata, xnnz, <int>y, 1, wbardata, u)
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":132
 *                 u = <double>(E*n - (n*e+i+1))
 *                 if z != y:
 *                     add(wdata, wstride, xdata, xnnz, <int>y, 1, wbardata, u)             # <<<<<<<<<<<<<<
 *                     add(wdata, wstride, xdata, xnnz, z, -1, wbardata, u)
 ...
 */
        ...
        /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":133
 *                 if z != y:
 *                     add(wdata, wstride, xdata, xnnz, <int>y, 1, wbardata, u)
 *                     add(wdata, wstride, xdata, xnnz, z, -1, wbardata, u)             # <<<<<<<<<<<<<<
 *                     nadds += 1
 ...
 */
        ...
        /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":134
 *                     add(wdata, wstride, xdata, xnnz, <int>y, 1, wbardata, u)
 *                     add(wdata, wstride, xdata, xnnz, z, -1, wbardata, u)
 *                     nadds += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":136
 *                     nadds += 1
 * 
 *                 i += 1             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":138
 *                 i += 1
 *             # report epoche information
 *             if verbose > 0:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_8 = __Pyx_PyObject_IsTrue(__pyx_t_6); if (unlikely(__pyx_t_8 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 138; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    if (__pyx_t_8) {

      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":139
 *             # report epoche information
 *             if verbose > 0:
 *                 print("NADDs: %d; NNZs: %d. " % (nadds, w.nonzero()[0].shape[0]))             # <<<<<<<<<<<<<<
 *                 print("Total training time: %.2f seconds." % (time()-t1))
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_11 = PyObject_GetAttr(((PyObject *)__pyx_v_w), __pyx_kp_nonzero); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_1 = PyObject_Call(__pyx_t_11, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
      __pyx_4 = __Pyx_GetItemInt(__pyx_t_1, 0, sizeof(long), PyInt_FromLong); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_4);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = PyObject_GetAttr(__pyx_4, __pyx_kp_shape); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_4); __pyx_4 = 0;
      __pyx_1 = __Pyx_GetItemInt(__pyx_t_1, 0, sizeof(long), PyInt_FromLong); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_1);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      ...
      __pyx_t_6 = 0;
      __pyx_1 = 0;
      __pyx_t_6 = PyNumber_Remainder(__pyx_kp_35, ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
      if (__Pyx_PrintOne(__pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;

      /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":140
 *             if verbose > 0:
 *                 print("NADDs: %d; NNZs: %d. " % (nadds, w.nonzero()[0].shape[0]))
 *                 print("Total training time: %.2f seconds." % (time()-t1))             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_kp_time); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_2);
      __pyx_t_6 = PyObject_Call(__pyx_2, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_2); __pyx_2 = 0;
      __pyx_t_1 = PyNumber_Subtract(__pyx_t_6, __pyx_v_t1); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyNumber_Remainder(__pyx_kp_36, __pyx_t_1); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      if (__Pyx_PrintOne(__pyx_t_6) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      goto __pyx_L10;
    }
    __pyx_L10:;
    __pyx_3 = __Pyx_PyInt_AsLong(__pyx_v_e); if (unlikely((__pyx_3 == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":143
 * 
 *         # floating-point under-/overflow check.
 ...
 * 
 */
  __pyx_4 = __Pyx_GetName(__pyx_m, __pyx_kp_np); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_4);
  __pyx_t_6 = PyObject_GetAttr(__pyx_4, __pyx_kp_any); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_kp_np); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_1);
  __pyx_t_1 = PyObject_GetAttr(__pyx_1, __pyx_kp_isinf); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
  ...
  __pyx_t_5 = PyObject_Call(__pyx_t_1, ((PyObject *)__pyx_t_11), NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GIVEREF(__pyx_t_5);
  __pyx_t_5 = 0;
  __pyx_t_5 = PyObject_Call(__pyx_t_6, ((PyObject *)__pyx_t_11), NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_11)); __pyx_t_11 = 0;
  ...
  if (!__pyx_t_8) {
    ...
    __Pyx_GOTREF(__pyx_2);
    __pyx_t_5 = PyObject_GetAttr(__pyx_2, __pyx_kp_any); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_2); __pyx_2 = 0;
    __pyx_4 = __Pyx_GetName(__pyx_m, __pyx_kp_np); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_4);
    __pyx_t_11 = PyObject_GetAttr(__pyx_4, __pyx_kp_isnan); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_11);
    __Pyx_DECREF(__pyx_4); __pyx_4 = 0;
    ...
    __Pyx_GIVEREF(((PyObject *)__pyx_v_w));
    __pyx_t_1 = PyObject_Call(__pyx_t_11, ((PyObject *)__pyx_t_6), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    ...
    __pyx_t_1 = 0;
    __pyx_t_1 = PyObject_Call(__pyx_t_5, ((PyObject *)__pyx_t_6), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(((PyObject *)__pyx_t_6)); __pyx_t_6 = 0;
    __pyx_t_13 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_13 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  if (__pyx_t_14) {
    ...
    /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":144
 *         # floating-point under-/overflow check.
 *         if np.any(np.isinf(w)) or np.any(np.isnan(w)):
 *             raise ValueError("floating-point under-/overflow occured.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_6 = PyObject_Call(__pyx_builtin_ValueError, ((PyObject *)__pyx_t_1), NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":146
 *             raise ValueError("floating-point under-/overflow occured.")
 * 
 *         model.W = wbar * (1.0 / (n*E))             # <<<<<<<<<<<<<<
 */
  __pyx_t_6 = PyFloat_FromDouble((1.0 / (__pyx_v_n * __pyx_v_E))); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 146; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_1 = PyNumber_Multiply(((PyObject *)__pyx_v_wbar), __pyx_t_6); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 146; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (PyObject_SetAttr(__pyx_v_model, __pyx_kp_W, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 146; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
#endif
{
  ...
  __pyx_refchk = __Pyx_Refnanny->NewContext("PyMODINIT_FUNC PyInit_avgperceptron(void)", __LINE__, __FILE__);
  #endif
  ...
  *(void(**)(void))&__pyx_vtable_4bolt_7trainer_13avgperceptron_AveragedPerceptron._train_multi = (void(*)(void))__pyx_f_4bolt_7trainer_13avgperceptron_18AveragedPerceptron__train_multi;
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":8
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":9
 * 
 * import numpy as np
 * import sys             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":14
 * cimport cython
 * 
 ...
 */
  ...
  /* "/home/peter/workspace/bolt/bolt/trainer/avgperceptron.pyx":17
 * 
 * __authors__ = [
 ...
 */
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_kp___authors__, ((PyObject *)__pyx_t_1)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_2);
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("bolt.trainer.avgperceptron");
